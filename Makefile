...
ci:
	mkdir node_modules && npm install elm && ./node_modules/.bin/elm-package install -y && cd tests && ../node_modules/.bin/elm-package install -y && export PATH=${PATH}:/home/travis/build/cmloegcmluin/scalar-set-theory/tests/elm-stuff/packages/rtfeldman/node-test-runner/3.0.0/bin && ../node_modules/.bin/elm-test
