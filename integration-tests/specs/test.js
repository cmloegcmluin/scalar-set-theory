...
describe('range of equal divisions', function () {
	it('updates the rows and count of rows when min or max filter is changed', function () {
		...
		assert.equal(browser.getText('//table/tr[9]/td[1]'), '5')
		assert.equal(browser.getText('//table/tr[13]/td[1]'), '6')
		assert.equal(browser.getText('//table/tr[18]/td[1]'), '7')
		...
		assert.equal(browser.getText('//table/tr[13]/td[1]'), '7')
	})
})

describe('range of nChords', function () {
	it('updates the ranges of nChords for each equal division', function () {
