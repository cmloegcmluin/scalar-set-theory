module ScalarSetTheoryTests.Components.DropdownTests exposing (dropdownTests)
...
dropdownTests =
    describe "dropdownOptions"
        [ test "for equal divisions, when the analysis settings are at their ultimate maxes and mins, and the dropdown is for the min, it returns the full ultimate range (between 3 and 100), with the specified option selected" <|
            \() ->
                let
                    expected =
                    ...
                    actual =
                        dropdownOptions analysisSettingValues Min "8"
                in
                equal expected actual
        , test "for equal divisions, when the analysis settings are at their ultimate maxes and mins, and the dropdown is for the max, it also returns the full ultimate range, with the specified option selected as always" <|
            \() ->
                let
                    expected =
                        fullEqualDivisionRange
                    ...
                    actual =
                        dropdownOptions analysisSettingValues Max "8"
                in
                equal expected actual
        , test "for equal divisions, when the analysis setting min is above the ultimate min, and the analysis setting max is at the ultimate max, and the dropdown is for the min, still returns the full ultimate range, specified option selected" <|
            \() ->
                let
                    expected =
                        fullEqualDivisionRange
                ...
                in
                equal expected actual
        , test "for equal divisions, when the analysis setting min is above the ultimate min, and the analysis setting max is at the ultimate max, and the dropdown is for the max, returns only the range between the selected min and the ultimate max, specified option selected" <|
            \() ->
                let
                    expected =
                ...
                in
                equal expected actual
        , test "for equal divisions, when the analysis setting max is below the ultimate max, and the analysis setting min is at the ultimate min, and the dropdown is for the min, returns only the range between the ultimate min and the selected max, specified option selected" <|
            \() ->
                let
                    expected =
                ...
                in
                equal expected actual
        , test "for equal divisions, when the analysis setting max is below the ultimate max, and the analysis setting min is at the ultimate min, and the dropdown is for the max, returns the full ultimate range, specified option selected" <|
            \() ->
                let
                    expected =
                        fullEqualDivisionRange
        ...
        , test "for nChords, returns a range between 2 and 100 instead of 3 to 100" <|
            \() ->
                let
                    ...
                    actual =
                        dropdownOptions analysisSettingValues Max "4"
                in
                equal expected actual
        ]
