...
dropdownTests =
    describe "dropdownOptions"
        [ test "for equal divisions, returns a range between 2 and 100, with the specified option selected" <|
            \() ->
                let
                    expected =
                        expectedEdOptions
...
expectedEdOptions : List (Html Msg)
expectedEdOptions =
...
expectedNChordOptions : List (Html Msg)
expectedNChordOptions =
