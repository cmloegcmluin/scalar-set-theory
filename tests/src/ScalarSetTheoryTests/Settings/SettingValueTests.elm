module ScalarSetTheoryTests.Settings.SettingValueTests exposing (settingValueTests)

import Expect exposing (equal)
import ScalarSetTheory.Settings.Setting exposing (Setting(Max, Min))
import ScalarSetTheory.Settings.SettingValue exposing (SettingValue, updateSettingValues)
